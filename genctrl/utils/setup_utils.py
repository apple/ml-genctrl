...
def setup_wandb(cfg: DictConfig) -> wandb.apis.public.Run:
    ...
    if Path("configs/.wandb.yaml").exists():
        wandb_config = load_yaml("configs/.wandb.yaml")
        ...
        raise FileNotFoundError(
            "Cannot find 'configs/.wandb.yaml'. You must set it if you want to use WandB, with content:\n"
